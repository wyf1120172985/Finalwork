...
import com.example.minidouyin.utils.NetworkUtils;
...
public class AddVideoActivity extends AppCompatActivity {
    ...
    private List<Call> mCallList2 = new ArrayList<>();
    ...
    private void postVideo() {
        ...
        /*Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("http://test.androidcamp.bytedance.com/") // 设置 网络请求 Url
        ...
        Call<PostVideoResponse>PostVideoResponseListCall = NetworkUtils.getPostVedioResponse(student_id,student_name
                ,image,video);
        mCallList2.add(PostVideoResponseListCall);
        PostVideoResponseListCall.enqueue(new Callback<PostVideoResponse>() {
            @Override
            public void onResponse(Call<PostVideoResponse> call, Response<PostVideoResponse> response) {
                ...
                else Toast.makeText(AddVideoActivity.this,"上传失败",Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(Call<PostVideoResponse> call, Throwable t) {
                mCallList2.remove(call);
                t.printStackTrace();
                Toast.makeText(AddVideoActivity.this,"数据接收失败",Toast.LENGTH_SHORT).show();
            }
        });
